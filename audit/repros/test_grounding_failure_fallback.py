...
@pytest.mark.parametrize('scenario', ['explicit-course', 'grounded-verification', 'explicit-course-wording', 'explicit-location'])
def test_grounding_outage_does_not_substitute_general_answer(monkeypatch, scenario):
    ...
    if scenario == 'explicit-location':
        question = 'Show me the exact source for the torsion formula.'
