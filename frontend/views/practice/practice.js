  ...
  function _init() {
    ...
    (function () {
      ...
      window._glOpenReadingView = function () {
        ...
        if (profileId) {
          ...
          if (st && (st.status === 'loading' || st.status === 'idle')) {
            ...
            if (typeof window._glExamOnReady === 'function') window._glExamOnReady(function () { if (_glActiveSkill === 'reading') window._glOpenReadingView(); });
            return;
          }
          var openPartId = rd.partId && rdPart(rd.partId) && rdPart(rd.partId).implemented ? rd.partId : rdFirstPartId();
      ...
      window._glRegisterProfileReset(function (nextProfileId) {
        ...
        var switcher = rdEl('glReadingPartSwitcher');
