...
_SYSTEM = (
    ...
    "language, e.g. \"Typische Prüfungsfragen\") listing 3-5 professor-style exam questions "
    "that this topic could produce. These help students anticipate the exam format.\n"
    ...
    "Lackieren, Härten\"). This is the most effective self-test for classifications.\n"
