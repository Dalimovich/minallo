...
_WEEK_PLAN_SYSTEM = (
    ...
    "This map may start LATER than Monday (past days are intentionally omitted "
    "because they are unreachable) — use ONLY the dayIndex keys present in it and "
    "NEVER emit a task for a day that isn't in the map.\n"
