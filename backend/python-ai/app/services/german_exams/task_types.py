...
TASK_TYPES: dict[str, bool] = {
    ...
    "video_speaker_statement_matching": True,
    "video_outline_completion": True,
    "listening_multiple_choice": True,
    "sound_script_comparison": True,
    "argumentative_essay": True,
    "text_graph_summary": True,
    "spoken_advice": True,
    "spoken_option_comparison": True,
    "spoken_text_summary": True,
    "spoken_information_comparison": True,
    "recorded_topic_presentation": True,
    "spoken_argument_response": True,
    "spoken_measure_critique": True,
