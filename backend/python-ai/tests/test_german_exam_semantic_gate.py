...
targeted HV2/HV3 adjudicator. Confirms the two failure modes Phase 2.5b
measured are both addressed: a detector false-positive gets overridden by
an adjudicator that finds the item clean, and a detector false-negative
(clean pass on a real defect) gets caught because the adjudicator ALWAYS
runs for HV2/HV3, not only when the detector already flagged something."""
